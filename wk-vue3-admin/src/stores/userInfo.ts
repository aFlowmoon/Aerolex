...
export const useUserInfo = defineStore('userInfo', {
    state: (): UserInfo => {
        return {
            ...
            roles: [],
            permissions: [],
            routes: {} as Record<string, any>, // 类型声明
            selfMenus: [],
            commonMenus: []
        }
    },
    actions: {
        ...
        setRoutes(obj: Record<string, any>): void { // 类型声明
        ...
        addStaticRoutes(data: any[]) { // 类型声明
            data.forEach((item: any) => {
                const obj: Record<string, any> = {} // 类型声明
                obj[item.path] = {}
                this.setRoutes(obj)
                if(item.children){
        ...
        generateMenus(data: any[], pid: string, pname: string) : any[]{ // 类型声明
            const arr:any = []
            let tree:any = {}
            const obj: Record<string, any> = {} // 类型声明
            data.forEach((item: any) => {
