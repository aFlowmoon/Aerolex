...
const newsTreeData = ref<NewsItem[]>([])
const newsData = ref<NewsItem[]>([])
const selectNews = ref<NewsItem[]>([])
const showUser = ref(false)
const userData = ref<UserItem[]>([])
const selectUser = ref<UserItem[]>([])
...
const list = () => {
    ...
    getList(queryParams.value).then((res) => {
        ...
        tableData.value = res.data.list as TableRow[]
...
const listNews = () => {
    ...
    getNewsList(queryNewsParams.value).then((res) => {
        newsData.value = res.data.list as NewsItem[]
...
const listUser = () => {
    ...
    getUserList(queryUserParams.value).then((res) => {
        userData.value = res.data.list as UserItem[]
